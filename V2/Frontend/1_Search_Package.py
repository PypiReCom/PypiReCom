...
def generate_search_url(search_text, search_exact):
    return api_endpoint + '/search?Search_Text=' + search_text + '&Search_Exact=' + str(search_exact)
...
def main():
    ...
    #result
    if search_button:
        search_url = generate_search_url(search_text, st.session_state['search_exact'])
