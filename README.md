...
# Pip Package with Depedency Recomender
...
So we can see if we are searching for api development it is only 
showing django as a big package.

On the other side, this is what google tells us.

![Google Screenshot](https://drive.google.com/uc?export=view&id=1sVHc249P3CmW696rTW57WTmkT8ItbrCn)

Now, I hope the differnce is clear some packages which are very popular
like Flask and FastAPI are not there.
